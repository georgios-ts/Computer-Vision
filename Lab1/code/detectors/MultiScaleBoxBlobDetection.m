function [Bx, By, sg] = MultiScaleBoxBlobDetection(I, sg0, s, N)
% Multi Scale Blob Detection with Hessian - Laplace method and Box Filters.
...
for i = 0:N-1
    ...
    B(:,:,i+1) = BoxBlobDetection(I, sigma);
end
